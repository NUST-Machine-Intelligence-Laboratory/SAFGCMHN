...
def compute_mAP(img, vid, aud, txt):
    ...
    video_labels = np.loadtxt('video_feature_label.txt')
...
if __name__ == '__main__':
    img = "./feature/image/features_te.txt"
    vid = "./vector_video_feature/san_calout_video/features_te.txt"
    aud = "./feature/audio/features_te.txt"
    txt = "./feature/text/features_te.txt"
